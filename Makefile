...
hakuBot: request.o server.o hakuMind.o json.o api.o errorMsg.o plugin.o main.o plugins
	cc request.o server.o hakuMind.o json.o api.o errorMsg.o plugin.o main.o `pkg-config --libs json-glib-1.0 python3` -lcurl -luv -rdynamic -ldl -Wl,-z,origin -Wl,-rpath='$$ORIGIN' -o hakuBot
